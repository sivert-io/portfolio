      ...
      {isLoading && (
        ...
        >
          <motion.div
            ...
            initial={isPageTransition ? { x: '-110%', opacity: 1 } : { opacity: 1 }}
            animate={isPageTransition ? { x: 0, opacity: 1 } : { opacity: 1 }}
            exit={
              isPageTransition
                ? { x: '110%', opacity: 1, transition: { duration: 0.45, ease: 'easeInOut' } }
